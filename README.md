...
| shipped from | `main` at `74c7e7e`, deployed 2026-08-30 — the member badge across the trial boundary. `/api/health` reports the deployed commit, so "did it land" has an answer rather than a guess about caching |
