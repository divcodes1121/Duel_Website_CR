...
```bash
npx tsc -b                        # typecheck
npm run test                      # 970 tests over the deck, duel, export, admin, nav, pager, shader, coach and dashboard logic
